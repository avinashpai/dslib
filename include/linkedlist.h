...
#define LL_CONTAINS(list, data, cmp) ll_contains(&list, (void *)data, cmp)
#define LL_GET(list, data, cmp) ll_get(&list, (void *)data, cmp)
#define LL_REMOVE(list, data, cmp) ll_remove(&list, (void *)data, cmp)
